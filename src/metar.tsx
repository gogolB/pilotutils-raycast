...
function calculateDensityAltitude(metar: METAR_DATA): number {
    ...
    const pressureAtSeaLevelInHpa = pressureInHpa / Math.pow(1 - (0.0065 * pressureAltitude) / temperatureInKelvin, 5.2561);

    const densityAltitude = (temperatureInKelvin / 0.0065) * (1 - Math.pow(pressureAtSeaLevelInHpa / pressureInHpa, 0.190284)) - 273.15;
                        ...
                        <List.Item.Detail
                            ...
                            metadata={
                                <List.Item.Detail.Metadata>
                                    ...
                                    <List.Item.Detail.Metadata.Label title="Pressure Altitude" text={`${metar.pressure_alt.toString()}ft`}/>
                                    <List.Item.Detail.Metadata.Label title="Density Altitude" text={`${metar.density_alt.toString()}ft`}/>
                                    ...
                                    <List.Item.Detail.Metadata.Label title="Report Time (Local)" text={metar.reportTime_local.toString()}/>
                                    <List.Item.Detail.Metadata.Separator />
                                    ...
                                    {metar.wgst && <List.Item.Detail.Metadata.Label title="Wind Gust" text={`${metar.wgst.toString()} Knots`}/>}
                                    <List.Item.Detail.Metadata.Separator />
                                    ...
                                    {metar.pcp3hr && <List.Item.Detail.Metadata.Label title="3 Hour Precipitation" text={metar.pcp3hr.toString()}/>}
                                    {metar.pcp6hr && <List.Item.Detail.Metadata.Label title="6 Hour Precipitation" text={metar.pcp6hr.toString()}/>}
                                    {metar.pcp24hr && <List.Item.Detail.Metadata.Label title="24 Hour Precipitation" text={metar.pcp24hr.toString()}/>}
                                    ...
                                    {metar.clouds && metar.clouds.map((cloud) => (
