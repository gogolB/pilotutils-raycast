...
function drawForecast(fcst: Forcast_Data){
    ...
    return (
        <React.Fragment key={uuidv4()}>
            ...
            {fcst.timeGroup && <List.Item.Detail.Metadata.Label key={uuidv4()} title="Time Group" text={fcst.timeGroup.toString()}/> }
            {fcst.timeFrom && <List.Item.Detail.Metadata.Label key={uuidv4()} title="Time From" text={fcst.timeFrom.toString()}/>}
            {fcst.timeTo && <List.Item.Detail.Metadata.Label key={uuidv4()} title="Time To" text={fcst.timeTo.toString()}/>}
            {fcst.timeBec && <List.Item.Detail.Metadata.Label key={uuidv4()} title="Time Becoming" text={fcst.timeBec.toString()}/>}
            {fcst.fcstChange && <List.Item.Detail.Metadata.Label key={uuidv4()} title="Forecast Change" text={fcst.fcstChange.toString()}/>}
            {fcst.probability && <List.Item.Detail.Metadata.Label key={uuidv4()} title="Probability" text={fcst.probability.toString()}/>}
            {fcst.wdir && <List.Item.Detail.Metadata.Label key={uuidv4()} title="Wind Direction" text={fcst.wdir.toString()}/>}
            ...
            {fcst.wshearHgt && <List.Item.Detail.Metadata.Label key={uuidv4()} title="Wind Shear Height" text={fcst.wshearHgt.toString()}/>}
            {fcst.wshearDir && <List.Item.Detail.Metadata.Label key={uuidv4()} title="Wind Shear Direction" text={fcst.wshearDir.toString()}/>}
            {fcst.wshearSpd && <List.Item.Detail.Metadata.Label key={uuidv4()} title="Wind Shear Speed" text={fcst.wshearSpd.toString()}/>}
            ...
            {fcst.vertVis && <List.Item.Detail.Metadata.Label key={uuidv4()} title="Vertical Visibility" text={fcst.vertVis.toString()}/>}
            {fcst.wxString && <List.Item.Detail.Metadata.Label key={uuidv4()} title="Weather" text={fcst.wxString.toString()}/>}
            {fcst.notDecoded && <List.Item.Detail.Metadata.Label key={uuidv4()} title="Not Decoded" text={fcst.notDecoded.toString()}/>}
            {fcst.clouds && <List.Item.Detail.Metadata.Label key={uuidv4()} title="Clouds" />}
            {fcst.clouds && fcst.clouds.map((cloud) => (
